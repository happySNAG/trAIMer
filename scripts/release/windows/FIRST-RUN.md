# trAIMer — portable folder (advanced path)

> **Most people should not use this folder.** The trAIMer product is a
> normal Windows installer: run `trAIMer-Setup.exe`, then launch the app
...
1. Double-click **start-traimer.ps1** ("Run with PowerShell").
...
`traimer_capture_helper.exe` (it listens on 127.0.0.1 only) and start again.
